...
class LSTMModel:
    ...
    def build_model(self):
        ...
        if str(self.artist)+".h5" in os.listdir("python") and self.training == False:
            print("Loading saved weights from " + str(self.artist) + ".h5\n")
            model.load_weights("python/" + str(self.artist) + ".h5")
    ...
    def train(self, input_data, output_data):
        ...
        self._model.save_weights("python/"+str(self.artist)+".h5")
    ...
    def get_rhyming_endings(self, lyrics):
        ...
        if str(self.artist) + "_rhymes.txt" in os.listdir("python") and self.training == False:
            print("Loading saved rhyme endings from " + str(self.artist) + "_rhymes.txt\n")
            with open("python/" + str(self.artist) + "_rhymes.txt", "r", encoding="utf8") as f:
    ...
    #            will reduce error and ensure we get the desired rhyme "sound."
            ...
            with open("python/" + str(self.artist) + "_rhymes.txt", "w", encoding="utf8") as f:
